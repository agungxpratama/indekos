  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        <h2 class="subheading">Selamat Datang di IndeKos</h2>
        <h1 class="mb-4">Sewa kamar dengan harga yang terjangkau</h1>
        <p><a href="#" class="btn btn-primary">Informasi</a> <a href="#" class="btn btn-white">Contact us</a></p>
      </div>
    </div>
  </div>
</div> -->
