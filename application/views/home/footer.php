...
<script src="<?= base_url('assets_home/') ?>js/jquery-migrate-3.0.1.min.js"></script>
<script src="<?= base_url('assets_home/') ?>js/popper.min.js"></script>
<script src="<?= base_url('assets_home/') ?>js/bootstrap.min.js"></script>
<script src="<?= base_url('assets_home/') ?>js/jquery.easing.1.3.js"></script>
<script src="<?= base_url('assets_home/') ?>js/jquery.waypoints.min.js"></script>
<script src="<?= base_url('assets_home/') ?>js/jquery.stellar.min.js"></script>
<script src="<?= base_url('assets_home/') ?>js/jquery.animateNumber.min.js"></script>
<script src="<?= base_url('assets_home/') ?>js/bootstrap-datepicker.js"></script>
<script src="<?= base_url('assets_home/') ?>js/jquery.timepicker.min.js"></script>
...
<script src="<?= base_url('assets_home/') ?>js/scrollax.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="<?= base_url('assets_home/') ?>js/google-map.js"></script>
